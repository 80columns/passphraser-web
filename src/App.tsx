...
function App() {
    ...
    function generatePassphrase() {
        setPassphrase('{QUARANTINENINETEENS7425intermarinenineteen`bootleggednineteens');
    }
            ...
            >
                ...
                >
                    <Grid container
                        ...
                        gap={6}
                    >
                        <Typography variant='h5' minHeight={40} textAlign='center' style={{ maxWidth: '50vw', overflowWrap: 'break-word' }}>
                            {passphrase}
                        </Typography>
                        <Grid container
